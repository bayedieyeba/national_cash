...
import creditAvanceSalaire from '../images/creditAvanceSalaire.png';
    ...
    const handleClick = () => {
        ...
        return(
            <div className="d-flex justify-content-between p-5 mt-5 " style={{backgroundColor:'brosybrownlue'}}>
                            ...
                            <div>
                                <img src={creditAvanceSalaire} style={{height:'400px',width:'400px',display: 'block;',marginLeft:' auto;', marginRight: 'auto;'}} alt="" />
