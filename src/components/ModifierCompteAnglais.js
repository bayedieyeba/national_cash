...
const ModifierCompteAnglais = () => {
    ...
    useEffect(()=>{
        axios.get('http://localhost:4000/partie-anglais-compte-courant')
        .then(res=>{
        ...
        axios.get('http://localhost:4000/partie-anglais-compte-depot')
        .then(res=>{
        ...
        axios.get('http://localhost:4000/partie-anglais-compte-epargn')
        .then(res=>{
   ...
   const [afficheMessageModif,setAfficheMessageModif] = useState(false)
    ...
    const handleModifCompteDepotTerm = (e)=>{
        e.preventDefault()
        const requestOptions = {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        fetch('http://localhost:4000/modifier/compte-depot-terme-anglais',requestOptions)
    ...
    const handleModifComptePlanEpargne = (e) =>{
        ...
        fetch('http://localhost:4000/modifier/compte-plan-epargne-anglais',requestOptions)
        ...
        <div>
            { afficheFormCC && 
                <div className='m-5'>
                    ...
                    <div className="form-group">
                        ...
                        <textarea  value={cc_partie3}
                            onChange={(e)=> setCC_partie3(e.target.value)}
                        className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 4</label>
                        <textarea  value={cc_partie4}
                         onChange={(e)=> setCC_partie4(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
            ...
            { afficheFormDT && 
                <div className='m-5'>
                    ...
                    <form onSubmit={handleModifCompteDepotTerm}>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 1</label>
                    ...
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 3</label>
                        <textarea  value={depot_terme3}
                            onChange={(e)=> setDepotTerme3(e.target.value)}
                        className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 4</label>
                        <textarea value={depot_terme4} 
                            onChange={(e)=> setDepotTerme4(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 5</label>
                        <textarea   value={depot_terme5}
                            onChange={(e)=> setDepotTerme5(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
            ...
            { afficheFormPE && 
                <div className='m-5'>
                    ...
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 3</label>
                        <textarea   value={pe_partie3}
                            onChange={(e)=> setPE_partie3(e.target.value)}
                        className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 4</label>
                        <textarea  value={pe_partie4}
                             onChange={(e)=> setPE_partie4(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 5</label>
                        <textarea  value={pe_partie5}
                            onChange={(e)=> setPE_partie5(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div className="form-group">
                        <label for="exampleFormControlTextarea1">Partie 6</label>
                        <textarea  value={pe_partie6}
                            onChange={(e)=> setPE_partie6(e.target.value)}
                         className="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
...
export default ModifierCompteAnglais